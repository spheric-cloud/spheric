...
var (
	...
	headers = []metav1.TableColumnDefinition{
		...
		{Name: "Network", Type: "string", Description: "The network this network policy affects"},
		{Name: "Nic-Selector", Type: "string", Description: "The selector for network interfaces"},
...
func (c *convertor) ConvertToTable(ctx context.Context, obj runtime.Object, tableOptions runtime.Object) (*metav1.Table, error) {
	...
	tab.Rows, err = table.MetaToTableRow(obj, func(obj runtime.Object, m metav1.Object, name, age string) (cells []interface{}, err error) {
		...
		cells = append(cells, networkPolicy.Spec.NetworkRef.Name)
		cells = append(cells, metav1.FormatLabelSelector(&networkPolicy.Spec.NetworkInterfaceSelector))
