...
var (
	...
	headers = []metav1.TableColumnDefinition{
		...
		{Name: "TPS", Type: "string", Description: "Amount of tps the bucket class offers."},
		{Name: "IOPS", Type: "string", Description: "Amount of iops the bucket class offers."},
...
func (c *convertor) ConvertToTable(ctx context.Context, obj runtime.Object, tableOptions runtime.Object) (*metav1.Table, error) {
	...
	tab.Rows, err = table.MetaToTableRow(obj, func(obj runtime.Object, m metav1.Object, name, age string) (cells []interface{}, err error) {
		...
		cells = append(cells, bucketClass.Capabilities.TPS())
		cells = append(cells, bucketClass.Capabilities.IOPS())
