...
//+kubebuilder:rbac:groups=storage.spheric.cloud,resources=bucketclasses,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=storage.spheric.cloud,resources=bucketclasses/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=storage.spheric.cloud,resources=bucketclasses/finalizers,verbs=update
//+kubebuilder:rbac:groups=storage.spheric.cloud,resources=buckets,verbs=get;list;watch
