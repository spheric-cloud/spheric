...
type Generator[O srimeta.Object] interface {
	Source[O]
	healthz.HealthChecker
	manager.Runnable
}

type event[O srimeta.Object] struct {
...
type oldNewMapEntry[O srimeta.Object] struct {
	Old     *O
	Current *O
}

type oldNewMap[O srimeta.Object] map[string]*oldNewMapEntry[O]
...
type handler[O srimeta.Object] struct {
	Handler[O]
}

type generator[O srimeta.Object] struct {
	mu sync.RWMutex
...
func NewGenerator[O srimeta.Object](list func(ctx context.Context) ([]O, error), opts GeneratorOptions) Generator[O] {
...
type handlerRegistration[O srimeta.Object] struct {
