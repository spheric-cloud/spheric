...
func Run(ctx context.Context, streams clicommon.Streams, client sri.VolumeRuntimeClient, r renderer.Renderer, opts Options) error {
	...
	res, err := client.CreateVolume(ctx, &sri.CreateVolumeRequest{Volume: volume})
	if err != nil {
		return err
	}
