...
import (
	...
	"spheric.cloud/spheric/srictl-volume/cmd/srictl-volume/srictlvolume/get/status"
	"spheric.cloud/spheric/srictl-volume/cmd/srictl-volume/srictlvolume/get/volume"
