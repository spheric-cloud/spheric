...
func Run(ctx context.Context, streams clicommon.Streams, client sri.VolumeRuntimeClient, render renderer.Renderer, opts Options) error {
	res, err := client.ListVolumes(ctx, &sri.ListVolumesRequest{})
	if err != nil {
