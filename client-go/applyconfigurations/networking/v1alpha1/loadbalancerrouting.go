...
import (
	...
	apinetworkingv1alpha1 "spheric.cloud/spheric/api/networking/v1alpha1"
...
func extractLoadBalancerRouting(loadBalancerRouting *apinetworkingv1alpha1.LoadBalancerRouting, fieldManager string, subresource string) (*LoadBalancerRoutingApplyConfiguration, error) {
	b := &LoadBalancerRoutingApplyConfiguration{}
	err := managedfields.ExtractInto(loadBalancerRouting, internal.Parser().Type("cloud.spheric.spheric.api.networking.v1alpha1.LoadBalancerRouting"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
