...
func PrefixAllocation(name, namespace string) *PrefixAllocationApplyConfiguration {
	...
	b.WithAPIVersion("ipam.spheric.cloud/v1alpha1")
	return b
}
...
func extractPrefixAllocation(prefixAllocation *ipamv1alpha1.PrefixAllocation, fieldManager string, subresource string) (*PrefixAllocationApplyConfiguration, error) {
	b := &PrefixAllocationApplyConfiguration{}
	err := managedfields.ExtractInto(prefixAllocation, internal.Parser().Type("cloud.spheric.spheric.api.ipam.v1alpha1.PrefixAllocation"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
