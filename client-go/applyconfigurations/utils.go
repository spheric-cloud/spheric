...
import (
	...
	commonv1alpha1 "spheric.cloud/spheric/client-go/applyconfigurations/common/v1alpha1"
	applyconfigurationscomputev1alpha1 "spheric.cloud/spheric/client-go/applyconfigurations/compute/v1alpha1"
	applyconfigurationscorev1alpha1 "spheric.cloud/spheric/client-go/applyconfigurations/core/v1alpha1"
	applyconfigurationsipamv1alpha1 "spheric.cloud/spheric/client-go/applyconfigurations/ipam/v1alpha1"
	metav1 "spheric.cloud/spheric/client-go/applyconfigurations/meta/v1"
	applyconfigurationsnetworkingv1alpha1 "spheric.cloud/spheric/client-go/applyconfigurations/networking/v1alpha1"
	applyconfigurationsstoragev1alpha1 "spheric.cloud/spheric/client-go/applyconfigurations/storage/v1alpha1"
)
...
func ForKind(kind schema.GroupVersionKind) interface{} {
	switch kind {
	// Group=common.spheric.cloud, Version=v1alpha1
