...
func extractSubnet(subnet *corev1alpha1.Subnet, fieldManager string, subresource string) (*SubnetApplyConfiguration, error) {
	b := &SubnetApplyConfiguration{}
	err := managedfields.ExtractInto(subnet, internal.Parser().Type("cloud.spheric.spheric.api.core.v1alpha1.Subnet"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
