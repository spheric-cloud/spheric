...
func (c *virtualIPs) Apply(ctx context.Context, virtualIP *networkingv1alpha1.VirtualIPApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.VirtualIP, err error) {
	if virtualIP == nil {
...
func (c *virtualIPs) ApplyStatus(ctx context.Context, virtualIP *networkingv1alpha1.VirtualIPApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.VirtualIP, err error) {
	if virtualIP == nil {
		return nil, fmt.Errorf("virtualIP provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
