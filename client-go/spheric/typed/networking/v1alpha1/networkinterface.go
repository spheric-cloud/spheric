...
import (
	...
	networkingv1alpha1 "spheric.cloud/spheric/client-go/applyconfigurations/networking/v1alpha1"
...
func (c *networkInterfaces) Apply(ctx context.Context, networkInterface *networkingv1alpha1.NetworkInterfaceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NetworkInterface, err error) {
...
func (c *networkInterfaces) ApplyStatus(ctx context.Context, networkInterface *networkingv1alpha1.NetworkInterfaceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NetworkInterface, err error) {
	if networkInterface == nil {
		return nil, fmt.Errorf("networkInterface provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
