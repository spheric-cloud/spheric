...
func (c *resourceQuotas) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ResourceQuota, err error) {
	result = &v1alpha1.ResourceQuota{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *resourceQuotas) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourceQuotaList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ResourceQuotaList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("resourcequotas").
...
func (c *resourceQuotas) Create(ctx context.Context, resourceQuota *v1alpha1.ResourceQuota, opts v1.CreateOptions) (result *v1alpha1.ResourceQuota, err error) {
	result = &v1alpha1.ResourceQuota{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourcequotas").
...
func (c *resourceQuotas) Update(ctx context.Context, resourceQuota *v1alpha1.ResourceQuota, opts v1.UpdateOptions) (result *v1alpha1.ResourceQuota, err error) {
	result = &v1alpha1.ResourceQuota{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcequotas").
...
func (c *resourceQuotas) UpdateStatus(ctx context.Context, resourceQuota *v1alpha1.ResourceQuota, opts v1.UpdateOptions) (result *v1alpha1.ResourceQuota, err error) {
	result = &v1alpha1.ResourceQuota{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcequotas").
...
func (c *resourceQuotas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResourceQuota, err error) {
	result = &v1alpha1.ResourceQuota{}
...
func (c *resourceQuotas) Apply(ctx context.Context, resourceQuota *corev1alpha1.ResourceQuotaApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceQuota, err error) {
...
func (c *resourceQuotas) ApplyStatus(ctx context.Context, resourceQuota *corev1alpha1.ResourceQuotaApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceQuota, err error) {
	if resourceQuota == nil {
		return nil, fmt.Errorf("resourceQuota provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
