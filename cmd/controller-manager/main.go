...
import (
	...
	computecontrollers "spheric.cloud/spheric/internal/controllers/compute"
	computescheduler "spheric.cloud/spheric/internal/controllers/compute/scheduler"
	...
	ipamcontrollers "spheric.cloud/spheric/internal/controllers/ipam"
	networkingcontrollers "spheric.cloud/spheric/internal/controllers/networking"
	storagecontrollers "spheric.cloud/spheric/internal/controllers/storage"
	storagescheduler "spheric.cloud/spheric/internal/controllers/storage/scheduler"
...
func main() {
	...
	if controllers.Enabled(resourceQuotaController) {
		...
		if err := quota.AddAllToRegistry(registry, quotaevaluatorspheric.NewEvaluatorsForControllers(mgr.GetClient())); err != nil {
		...
		replenishReconcilers, err := quotacontrollerspheric.NewReplenishReconcilers(mgr.GetClient(), registry)
		if err != nil {
