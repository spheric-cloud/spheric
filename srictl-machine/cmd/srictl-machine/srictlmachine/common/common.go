...
import (
	...
	"spheric.cloud/spheric/srictl-machine/clientcmd"
	"spheric.cloud/spheric/srictl-machine/tableconverters"
...
func (o *Options) applyTableConvertersOverlay(cfg *clientcmd.TableConfig, reg *tableconverter.Registry) error {
	if err := applyTableConverterOverlay[*sri.Machine](reg, cfg.PrependMachineColumns, cfg.AppendMachineColumns); err != nil {
...
func (o *Options) Client() (sri.MachineRuntimeClient, func() error, error) {
	address, err := sriremotemachine.GetAddressWithTimeout(3*time.Second, o.Address)
	if err != nil {
		return nil, nil, err
	}
	...
	return sri.NewMachineRuntimeClient(conn), conn.Close, nil
}
