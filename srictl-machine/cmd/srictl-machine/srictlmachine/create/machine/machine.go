...
func Run(ctx context.Context, streams clicommon.Streams, client sri.MachineRuntimeClient, r renderer.Renderer, opts Options) error {
	...
	res, err := client.CreateMachine(ctx, &sri.CreateMachineRequest{Machine: machine})
	if err != nil {
		return err
	}
